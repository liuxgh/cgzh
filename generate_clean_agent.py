                  ...
                  >
                    ...
                    <div className="pt-4 mt-5 border-t border-slate-100 flex items-center justify-between text-sm">
                      ...
                      <button 
                        ...
                        className="text-white bg-[#0F52BA] px-4 py-2 rounded-lg font-bold flex items-center gap-1 shadow-sm hover:bg-[#082C6C] hover:shadow-md transition-all cursor-pointer"
                      >
                        AI撰写对接方案
