                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {TARGET_ENTERPRISES_DATA.map((ent) => (
                    <div
                      ...
                      className="group bg-white rounded-3xl p-6 border border-slate-200 shadow-sm hover:shadow-xl hover:border-[#0F52BA]/50 transition-all cursor-pointer flex flex-col justify-between relative overflow-hidden"
                    >
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          ...
                          <div className="bg-emerald-50/50 rounded-xl p-3 border border-emerald-100/50 flex flex-col items-center justify-center text-center">
                            <span className="text-[11px] text-emerald-600 font-bold mb-1">备案产品</span>
                            <span className="text-lg font-black text-slate-900 tracking-tight">{ent.patentProducts?.length || 0}</span>
                          </div>
                        ...
                        {ent.keyInventors && ent.keyInventors.length > 0 && (
                          <div className="bg-slate-50 px-4 py-3 rounded-xl border border-slate-100 flex items-center gap-3 text-[13px]">
                             <div className="text-slate-500 font-medium shrink-0 flex items-center gap-1"><User className="w-4 h-4" /> 联系人:</div>
                             <div className="text-slate-800 font-bold flex gap-4">
                      ...
                      <div className="pt-4 mt-5 border-t border-slate-100 flex items-center justify-between text-sm">
                        ...
                        <span className="text-white bg-[#0F52BA] px-4 py-2 rounded-lg font-bold flex items-center gap-1 shadow-sm group-hover:bg-[#082C6C] group-hover:shadow-md transition-all">
                          查看全景画像
