        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative w-full md:w-64 shrink-0">
            <input
              ...
              className="w-full bg-[#F8FAFC] border border-slate-200 rounded-xl px-3 py-2 pl-8 text-xs text-slate-900 focus:outline-hidden focus:border-[#0F52BA] focus:bg-white"
            />
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h5 className={`text-xs font-bold line-clamp-1 ${isSelected ? 'text-[#082C6C] font-black' : 'text-slate-800'}`}>
                    {chain.name}
                  </h5>
                </div>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-md space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-6 border-b border-slate-200">
            ...
            <div className="bg-indigo-50/80 p-4 rounded-2xl border border-indigo-100 shrink-0 space-y-1">
              ...
              <p className="text-xs text-slate-800 font-semibold">{activeChain.jluAdvantageCollege}</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-black text-slate-900 flex items-center gap-2">
                ...
                <span className="text-xs font-normal text-slate-500">（点击节点可快速筛选该环节靶向企业）</span>
              </h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <h5 className="text-sm font-bold text-slate-900">{activeChain.upstreamNode.name}</h5>
              ...
              >
                ...
                <h5 className="text-sm font-bold text-slate-900">{activeChain.midstreamNode.name}</h5>
                <div className="space-y-1 text-xs text-slate-600">
                  <span className="text-[11px] font-semibold text-slate-500 block">关键攻关技术特征：</span>
              ...
              >
                ...
                <h5 className="text-sm font-bold text-slate-900">{activeChain.downstreamNode.name}</h5>
                <div className="space-y-1 text-xs text-slate-600">
                  <span className="text-[11px] font-semibold text-slate-500 block">关键攻关技术特征：</span>
              ...
              {chainEnterprises.map((ent) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="font-mono text-lg font-black text-emerald-600 shrink-0">
                      {ent.matchScore}分
                    </span>
                  </div>
