...
export const INITIAL_PATENTS: PatentItem[] = [
  ...
  },
  {
    ...
    college: '化学学院 / 无机合成与超分子化学国家重点实验室',
    inventor: '马於光 院士团队',
  ...
  },
  {
    ...
    college: '生物与农业工程学院 / 农业部东北现代农业装备重点实验室',
    inventor: '杨印生 教授团队',
  ...
  },
  {
    ...
    college: '建设工程学院 / 复杂地层钻进技术国家地方联合工程实验室',
    inventor: '孙友宏 院士团队',
  ...
  },
  {
    ...
    college: '地球探测科学与技术学院 / 地下信息探测技术国家级实验教学示范中心',
    inventor: '黄大年科研团队传承组 / 林君 院士团队',
  ...
  },
  {
    ...
    college: '机械与航空航天工程学院 / 高端数控机床与智能制造团队',
    inventor: '赵宏伟 教授团队',
