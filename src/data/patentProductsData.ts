...
export const PATENT_INTENSIVE_PRODUCTS_DATA: PatentIntensiveProduct[] = [
  {
    ...
    productName: '启源E07汽车',
    filingEnterprise: '重庆长安汽车股份有限公司',
    location: '重庆市江北区',
    industryCategory: '新能源乘用车制造',
    productCategoryHierarchy: '交通运输设备 > 汽车 > 乘用车 > 运动型多用途乘用车（SUV）',
    productImageUrl: 'https://images.unsplash.com/photo-1617788138017-80ad40651399?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '50亿-100亿元',
    corePatentsTotal: 1268,
    productDescription: '全球首款量产可变新汽车，中大型智能电动SUV，形态可变、功能可变、软件可变，极具未来感的赛伯设计，科幻感十足。采用星环数智前脸设计，为全行业首发车外彩色交互前脸，搭配星环一体式前大灯，主动进气智能格栅。实现一室一厅一露台，彻底打破传统车内空间界定。拥有领先同级超长续航与数智线控底盘架构。',
    keyComponents: ['星环数智彩色交互前脸', 'SDA天枢架构智能可变底盘', '全冗余智能线控转向', '高能量密度CTB电池系统'],
    jluSynergyPatentField: '面向智能新能源汽车的线控电液复合制动系统与多模态能量回收控制',
    ...
    techSynergyDetail: '吉大线控电液复合制动多轴协同滑模控制算法与高精度能量回收逻辑，可直接赋能启源E07可变底盘在极限工况下的制动响应与续航回收率，缩短制动距离12%。',
    targetEnterpriseId: 'ent-changan'
  },
  {
    id: 'prod-weichai-01',
    productCode: '20253700003692.8',
    productName: '发动机',
    filingEnterprise: '潍柴动力股份有限公司',
    location: '山东省潍坊市',
    industryCategory: '动力设备制造与内燃机研发',
    productCategoryHierarchy: '通用设备 > 发动机 > 汽车用发动机 > 汽车用柴油发动机',
    productImageUrl: 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?auto=format&fit=crop&w=600&q=80',
    filingYear: '2026年度',
    status: '国家专利密集型产品',
    annualOutputValue: '100亿-500亿元',
    corePatentsTotal: 1107,
    productDescription: '潍柴蓝擎发动机，结构紧凑，满足国六排放；整车NVH定制开发、低噪音、低振动。降标配WCBS，制动功率最高达254kW；发动机B10寿命突破180万公里。最低油耗转速覆盖整个工作转速区域；潍柴国六自主ECU控制系统，改善驾驶员换挡规律，降低油耗；整车相同车速发动机转速匹配点低。',
    keyComponents: ['WCBS高制动功率控制阀组', '高热效率燃烧室结构', '全工况电控自主ECU', '低摩擦纳米涂层运动副'],
    jluSynergyPatentField: '重载车辆电液协同制动系统与动力总成综合能效管理',
    matchedJluPatentId: 'pat-001',
    compatiblePatentIds: ['pat-001', 'pat-006', 'pat-007'],
    matchedJluPatentTitle: '一种面向智能新能源商用车的线控电液复合制动系统与能量回收控制方法',
    matchedJluInventor: '高镇海',
    matchedJluCollege: '商用汽车底盘集成与节能控制团队',
    techSynergyDetail: '吉大面向重载商用车线控制动与电液复合能量回收策略，与潍柴WCBS高制动功率模块联合标定，可在长下坡重载制动中减免刹车片磨损达35%，显著改善重型卡车综合运行安全性。',
    targetEnterpriseId: 'ent-weichai'
  },
  {
    id: 'prod-01',
    ...
    productCategoryHierarchy: '电气机械和器材制造 > 电池制造 > 锂离子动力蓄电池系统',
    productImageUrl: 'https://images.unsplash.com/photo-1558441719-8b489c63f77a?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '100亿-500亿元',
  ...
  },
  {
    ...
    productCategoryHierarchy: '交通运输设备 > 汽车 > 汽车零部件及配件 > 智能线控滑板底盘',
    productImageUrl: 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '100亿-500亿元',
    corePatentsTotal: 88,
  ...
  },
  {
    ...
    productCategoryHierarchy: '仪器仪表制造 > 光学仪器 > 智能车载感知模组',
    productImageUrl: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
  ...
  },
  {
    ...
    productCategoryHierarchy: '专用设备制造 > 医疗仪器设备及器械 > 临床检验分析仪器',
    productImageUrl: 'https://images.unsplash.com/photo-1582719471384-894fbb16e074?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '10亿-50亿元',
    corePatentsTotal: 92,
  ...
  },
  {
    ...
    productCategoryHierarchy: '通用设备制造 > 金属切削机床 > 高档五轴数控加工中心',
    productImageUrl: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
  ...
  },
  {
    ...
    productCategoryHierarchy: '计算机通信和电子设备制造 > 电子元器件 > 柔性AMOLED显示器件',
    productImageUrl: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '100亿-500亿元',
  ...
  },
  {
    ...
    productCategoryHierarchy: '化学纤维制造 > 高性能纤维 > PAN基高强碳纤维复合材料',
    productImageUrl: 'https://images.unsplash.com/photo-1508614589041-895b88991e3e?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '10亿-50亿元',
    corePatentsTotal: 28,
  ...
  },
  {
    ...
    productCategoryHierarchy: '专用设备制造 > 农林牧渔专用机械 > 大马力智能轮式拖拉机',
    productImageUrl: 'https://images.unsplash.com/photo-1592878904946-b3cd8ae243d0?auto=format&fit=crop&w=600&q=80',
    filingYear: '2025年度',
    status: '国家专利密集型产品',
    annualOutputValue: '10亿-50亿元',
    corePatentsTotal: 42,
